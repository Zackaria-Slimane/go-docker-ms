...
func createComment(w http.ResponseWriter, r *http.Request) {
	...
	//if there's an error with decoding the information send a response with an error
	if err != nil {
		handleErr(w, err)
		return
	}
	...
	//if we can't get the db let's handle the error and send a response
	if !ok {
...
func getComments(w http.ResponseWriter, r *http.Request) {
	...
	//encode the success response to json and send it back
	err = json.NewEncoder(w).Encode(res)
	if err != nil {
